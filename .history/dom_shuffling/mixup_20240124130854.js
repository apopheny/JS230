...
let babyImage = document.querySelector('img');
let chinStickImage = document.querySelectorAll('img')[1];
[babyImage.src, babyImage.alt, chinStickImage.src, chinStickImage.alt] = [chinStickImage.src, chinStickImage.alt, babyImage.src, babyImage.alt];