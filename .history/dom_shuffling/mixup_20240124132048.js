...
let [babyImage, chinStickImage] = document.body.querySelectorAll('img');
let [fig1, fig2] = document.body.querySelectorAll('figure');
fig1.insertAdjacentElement('afterbegin', chinStickImage);
fig2.insertAdjacentElement('afterbegin', babyImage);
