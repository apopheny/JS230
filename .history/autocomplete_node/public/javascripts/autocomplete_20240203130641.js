const Autocomplete = {
  ...
  draw() {
    ...
    // Autocomplete.visible serves as a flag to display the list UI or not, depending on if there is text entered in the input. If it's not visible, the overlay shouldn't have text. I'm not sure if this is necessary, though, as all text should be in the input or UI list
    if (!this.visible) {
